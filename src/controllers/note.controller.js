...
export const addNoteInArchive = async (req, res, next) => {
  try {
    const data = await NoteService.addNoteInArchive(req.params._id);
    res.status(HttpStatus.ACCEPTED).json({
      code: HttpStatus.ACCEPTED,
      data: data,
...
export const removeNoteFromArchive = async (req, res, next) => {
  try {
    const data = await NoteService.removeNoteFromArchive(req.params._id);
    res.status(HttpStatus.ACCEPTED).json({
      code: HttpStatus.ACCEPTED,
      data: data,
...
export const addNoteInTrash = async (req, res, next) => {
  try {
    const data = await NoteService.addNoteInTrash(req.params._id);
    res.status(HttpStatus.ACCEPTED).json({
      code: HttpStatus.ACCEPTED,
      data: data,
...
export const removeNoteFromTrash = async (req, res, next) => {
  try {
    const data = await NoteService.removeNoteFromTrash(req.params._id);
    res.status(HttpStatus.ACCEPTED).json({
      code: HttpStatus.ACCEPTED,
      data: data,
